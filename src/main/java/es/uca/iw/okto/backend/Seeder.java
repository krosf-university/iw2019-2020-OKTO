...
public class Seeder implements ApplicationListener<ContextRefreshedEvent> {
  ...
  void realData() {
    ...
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), busan, "Busan Tour",
        "Tour around Busan", 30.00, ship1);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), colon, "Colon Tour",
        "Tour around Colon", 20.00, ship4);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), jeddah, "Jeddah Tour",
        "Tour around Jeddah", 20.00, ship2);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), valencia, "Valencia Tour",
        "Tour around Valencia", 20.00, ship2);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), istambul, "Istambul Tour",
        "Tour around Istambul", 20.00, ship2);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), istambul, "Istambul Tour",
        "Tour around Istambul", 20.00, ship5);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), hamburg, "Hamburg Tour",
        "Tour around Hamburg", 20.00, ship5);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), tokio, "Tokio Tour",
        "Tour around Tokio", 20.00, ship1);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), barcelona, "Barcelona Tour",
        "Tour around Barcelona", 20.00, ship2);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), la, "LA Tour", "TOur around LA",
        20.00, ship5);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), hamburg, "Hamburg Tour",
    ...
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), amberes, "Amberes Tour",
        "Tour around Amberes", 20.00, ship3);
    createTourIfNotFound(LocalDate.now(), LocalDate.now(), roterdam, "Rotterdam Tour",
  ...
  @Transactional
  void createTourIfNotFound(final LocalDate start, final LocalDate end, final City city,
