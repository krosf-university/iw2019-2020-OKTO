...
import es.uca.iw.okto.backend.utils.EntityUtil;
import es.uca.iw.okto.backend.utils.TemplateUtil;
...
public abstract class AbstractCrudView<E extends AbstractEntity> extends Crud<E> implements HasUrlParameter<Long>, HasNotifications {
  ...
  private static final long serialVersionUID = -8296867854503408162L;
