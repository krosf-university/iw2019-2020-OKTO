...
@Route(value = ConsultarViajeCrucero.ROUTE, layout = MainViewCliente.class)
...
//consejos para los viajeros, servicios e instalaciones disponibles en el barco, planos de localización
